    ...
    >
      ...
      <el-form-item label="网站icon:" prop="icon">
        <el-input
          ...
          placeholder="请填写以'icon-'开头的icon名称"
        />
      </el-form-item>
                    ...
                    <div class="selectInput">
                      ...
                      <div v-show="item.showOption" class="flavorSelect">
                        <span
                          ...
                          >{{ it.name }}</span
                        >
                        <span v-if="dishFlavorsData.length == 0" class="none"
                          >无数据</span
                        >
                      </div>
                    </div>
      ...
      <el-form-item label="网站描述:">
        <el-input
          ...
          type="textarea"
          :rows="3"
          placeholder="网站描述，最长200字"
          maxlength="200"
        />
      </el-form-item>
      <div class="subBox address">
        <el-form-item>
          <el-button size="large" @click="goBack(ruleFormRef)">
            取消
          </el-button>
          <el-button
            size="large"
            type="primary"
            @click="submitForm(ruleFormRef, null)"
          >
            保存
          </el-button>
          <el-button
            ...
            type="primary"
            class="continue"
            @click="submitForm(ruleFormRef, 'goAnd')"
          >
            保存并继续添加
          </el-button>
        </el-form-item>
